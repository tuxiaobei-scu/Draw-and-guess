...
public class DrawPoint extends Component implements Component.DrawTask {
    ...
    ColorSelectButtons switchcolor = new ColorSelectButtons();
     ...
     */
    public DrawPoint(Context context, Boolean candraw) {
        super(context);
        init(candraw);
    }
    ...
    private void init(Boolean candraw) {
        paint = new Paint();
        ...
        if (candraw) {
            setTouchEventListener((component, touchEvent) -> {
                ...
                Color color = switchcolor.getColor();
    ...
    public void addButton(Button color_button) {
        switchcolor.addButton(color_button);
    }
